...
export function projectList(state = initialProjectsState, action) {
    switch (action.type) {
...
export function addedProject(state = initialAddedProjectState, action) {
    switch (action.type) {
...
export function selectedProjectInfo(state = initialSelectedProjectState, action) {
    switch (action.type) {
...
export function updatedProject(state = initialUpdatedProjectState, action) {
    switch (action.type) {
...
export function deletedProject(state = initialDeletedProjectState, action) {
    switch (action.type) {
...
export function slideList(state = initialSlidesState, action) {
    switch (action.type) {
...
export function addedSlide(state = initialAddedSlideState, action) {
    switch (action.type) {
...
export function selectedSlide(state = initialSelectedSlideState, action) {
    switch (action.type) {
...
export function updatedSlide(state = initialUpdatedSlideState, action) {
    switch (action.type) {
...
export function deletedSlide(state = initialDeletedSlideState, action) {
    switch (action.type) {
