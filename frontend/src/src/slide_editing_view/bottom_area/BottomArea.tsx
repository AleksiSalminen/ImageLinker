...
function BottomArea(props) {
    ...
    return (
        <div>
            <Button variant="contained" onClick={saveChanges} style={{}}>{t("BottomArea.SaveButton")}</Button>
            
            <Button variant="contained" onClick={deleteSlide} style={{ marginLeft:"40%" }}>{t("BottomArea.DeleteButton")}</Button>
