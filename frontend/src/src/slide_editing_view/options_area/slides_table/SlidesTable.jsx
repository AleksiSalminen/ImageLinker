  ...
  and changes the slide editing view to be active */
    ...
    return (
        ...
        >
            <Box>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <SlidesTableSortButton slides={slides} updateSlides={updateSlides} />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <SlidesTableFilterButton filterHeading={filterHeading} setFilterHeading={setFilterHeading} />
            </Box>
            <br />
                        ...
                        >
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell>{t("SlidesTable.Heading")}</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
