        ...
        <Dialog open={props.open} style={{ padding: "0.5rem" }}>
            <Box style={{ padding: "1rem" }}>
                ...
                <Box style={{ marginTop: "1rem" }}>
                    <Button variant="outlined" style={{ marginRight: "2rem" }}>
                        {t("OptionsArea.OptionsEditDialog.SaveButton")}
                    </Button>
                    <Button variant="outlined" style={{ marginRight: "2rem" }}>
                        {t("OptionsArea.OptionsEditDialog.DeleteButton")}
                    </Button>
                    <Button variant="outlined" style={{}} onClick={cancelChanges}>
                        {t("OptionsArea.OptionsEditDialog.CancelButton")}
                    </Button>
                </Box>
            </Box>
        </Dialog>
